...
train_dataset = ChloraData(root_dir, frames, shape_scale, is_month=True, mask_dir=mask_dir, is_train=True)
train_loader  = DataLoader(train_dataset, batch_size=1, shuffle=False)
test_dataset = ChloraData(root_dir, frames, shape_scale, is_month=True, mask_dir=mask_dir, is_train=False)
